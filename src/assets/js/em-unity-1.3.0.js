 ...
 */
 ...
 //function created to initialized appended html code after being appended
function initAccordian(){

	var accordionItem = document.querySelector('.em-js-accordion-item');
	var accordionBtn = document.querySelector('.em-js-accordion-trigger');
...
(function(){
	...
	for (i=0; i<characterCounter.length; i++) {
...
(function(){
	...
	for (j=0; j<draggableTable.length; j++) {
...
(function(){
	...
	for (i=0; i<dropdownRadioTrigger.length; i++) {
		...
		e.preventDefault();
			...
			if (this.parentElement.classList.contains('em-is-active')) {
				...
				for (j=0; j<dropdownRadioPanel.length; j++) {
...
var loadPrimaryNav = (function primaryNav(){
	...
	for (l=0; l<dropdownTrigger.length; l++) {
